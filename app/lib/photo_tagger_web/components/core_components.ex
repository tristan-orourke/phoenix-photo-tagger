defmodule PhotoTaggerWeb.CoreComponents do
  @moduledoc """
      ...
      >
        <div class="min-h-full">
          <.focus_wrap
            ...
            class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden shadow-2xl transition"
          >
            <div class="absolute top-6 right-5 p-4">
              <button
                phx-click={JS.exec("data-cancel", to: "##{@id}")}
                type="button"
                class="-m-3 flex-none p-3 opacity-30 hover:opacity-60 text-zinc-500"
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "relative w-80 sm:w-96 z-50 rounded-lg p-3 mb-3 ring-1",
    ...
    >
      ...
      <button type="button" class="absolute group top-1 right-1 p-2" aria-label={gettext("close")}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhotoTaggerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhotoTaggerWeb.Gettext, "errors", msg, opts)
    end
  end
