...
#
#     PHX_SERVER=true bin/photo_tagger start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :photo_tagger, PhotoTaggerWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :photo_tagger, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  # Config basic auth
  config :photo_tagger, :basic_auth,
  ...
  #
  #     config :photo_tagger, PhotoTagger.Mailer,
