...
config :photo_tagger, PhotoTagger.Repo,
  username: "postgres",
  password: "postgres",
  # This is the name of the docker service
  hostname: "dev_db",
...
config :photo_tagger, PhotoTaggerWeb.Endpoint,
  ...
  # This had to be changed to 0,0,0,0 to work from within a docker container
...
config :photo_tagger, PhotoTaggerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/photo_tagger_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :photo_tagger, dev_routes: true
...
# Config basic auth
config :photo_tagger, :basic_auth, username: "admin", password: "admin"
