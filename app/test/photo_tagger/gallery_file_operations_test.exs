defmodule PhotoTagger.GalleryFileOperationsTest do
	...
	describe "photo file storage" do
		...
		test "create_photo/1 stores images in correct folder path", %{temp_dir: temp_dir, folder: folder} do
			photo = photo_fixture_with_files(%{temp_dir: temp_dir, folder_id: folder.id})
		...
		test "create_photo/1 generates correct filenames for each version", %{temp_dir: temp_dir, folder: folder} do
