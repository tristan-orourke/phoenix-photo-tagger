---
allowed-tools: Read, Edit(./docs/tasks.md), Edit(./docs/plans/*)
description: builds a detailed plan for the next item in a list of tasks.
---


@./docs/tasks.md contains a list of tasks. Each section is a task, possibly including subtasks, and a status. 
...
4. Edit @./docs/tasks.md to update the status for the task to "PLAN COMPLETE"
